...
class GetNews extends Component {
    ...
    componentDidMount() {
        ...
        fetch(`https://newsapi.org/v2/top-headlines?category=${this.props.route.params.category}&country=ph&apiKey=${config.API_KEY}`)
    ...
    render() {
        return (
            <View style={{ alignItems: 'center', backgroundColor: '#071433' }}>
                {
